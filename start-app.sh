...
echo -e "\n\nvisit to see beautiful app: http://localhost:8080/  | or http://0.0.0.0:8080/  for some browsers"
echo -e "visit to see api docs: http://localhost:8080/api/doc  | or http://0.0.0.0:8080/api/doc  for some browsers"
...
echo -e "\033[0;32m [TIP] Run: \`sudo docker compose exec app php bin/phpunit\` to run tests\033[0m"
